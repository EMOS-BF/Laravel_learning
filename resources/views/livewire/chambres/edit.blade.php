    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edition d'une chambre </h5>

            </div>
            <form wire:submit.prevent="updateChambre">
                    ...
                    <div class="d-flex">
                            <div class=" my-4 bg-gray-light p-3 flex-grow-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model="editChambre.numero_de_chambre" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="">Disponiblité</label>
                                    <select class="form-control" wire:model="editChambre.EstDisponible">
                                        <option value="">---------</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select  class="form-control" wire:model="editChambre.type_chambre_id">
                                        <option value=""></option>
                            ...
                            <div class="p-4 " >
                                        <div class="form-group">
                                            <input type="file" wire:model="editPhoto" id="">
                                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" >Valider les modification</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal" wire:click='closeEditModal'>Fermer</button>
                </div>
